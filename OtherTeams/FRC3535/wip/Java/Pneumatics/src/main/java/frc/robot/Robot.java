 ...
 * also be "off", where the solenoid will remain in its default power off state.
...
public class Robot extends TimedRobot {
 ...
 @Override
  ...
  public void teleopPeriodic() {
    /*
     * The output of GetRawButton is true/false depending on whether the button is
     * pressed; Set takes a boolean for whether to use the default (false) channel
     * or the other (true).
     */
    // m_solenoid.set(m_stick.getRawButton(kSolenoidButton));

    /*
     * In order to set the double solenoid, if just one button is pressed, set the
     * solenoid to correspond to that button. If both are pressed, set the solenoid
     * will be set to Forwards.
     */
