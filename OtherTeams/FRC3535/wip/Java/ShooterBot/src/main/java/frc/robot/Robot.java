...
public class Robot extends TimedRobot {
  ...
  private int CANVenom(int i) {
    return 0;
  }
  
  // Venom
  public int mLeftRear =  CANVenom(4);
  public int mLeftFront =  CANVenom(3);
  public int mRightFront =  CANVenom(1);
  public int mRightRear =  CANVenom(2);
