...
public class Robot extends TimedRobot {
  ...
  // private SpeedControllerGroup m_LeftMotors = new
  // SpeedControllerGroup(m_Left0,m_Left1);
  // private SpeedControllerGroup m_RightMotors = new
  // SpeedControllerGroup(m_Right0,m_Right1);
  // private DifferentialDrive m_Drive = new
  ...
  public void teleopPeriodic() {
    ...
    double drive = -m_Controller.getRawAxis(1);
    double steer = m_Controller.getRawAxis(2);
