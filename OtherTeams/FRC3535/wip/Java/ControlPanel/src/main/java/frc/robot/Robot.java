...
public class Robot extends TimedRobot {
  TalonSRX m_ControlPanel = new TalonSRX(6);
  private static final String kDefaultAuto = "Default";
  private static final String kCustomAuto = "My Auto";
  private String m_autoSelected;
  private final SendableChooser<String> m_chooser = new SendableChooser<>();

  // DigitalInput dioSwitch;
  ...
  public void teleopPeriodic() {
    ...
    // if (dioSwitch.get()) {
    // System.out.println("Swtich: " + dioSwitch.get());

    // If is has been less than 2 seconds since autonomous started, drive forwards
    if (myTimer.get() < 2.0) {
      m_ControlPanel.set(ControlMode.PercentOutput, 0.125);
    }
