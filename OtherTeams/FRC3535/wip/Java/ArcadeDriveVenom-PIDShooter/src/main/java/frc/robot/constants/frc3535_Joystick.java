			...
			case 2: // Operator Controller
				switch (analog) {
					case 1: // Left Analog Stick
						switch (direction) {
							case 1: // Up or Down
								deadbandSpeed = js2.getRawAxis(frc3535_Variables.axisD_lUpDown); // Speed controls up &
																									// down
								if ((deadbandSpeed > frc3535_Variables.js2_L_UpDown_Deadband_Low)) {
									deadbandSpeed = ((deadbandSpeed - frc3535_Variables.js2_L_UpDown_Deadband_Low)
											* frc3535_Variables.js2_L_UpDown_Deadband_High);
								} else if ((deadbandSpeed < -frc3535_Variables.js2_L_UpDown_Deadband_Low)) {
									deadbandSpeed = ((deadbandSpeed + frc3535_Variables.js2_L_UpDown_Deadband_Low)
											* frc3535_Variables.js2_L_UpDown_Deadband_High);
								} else {
									deadbandSpeed = 0; // If between boundaries. Do nothing.
							...
							case 2: // Left or Right
								deadbandSpeed = js2.getRawAxis(frc3535_Variables.axisD_lLeftRight); // Speed controls up
																									// & down
								if ((deadbandSpeed > frc3535_Variables.js2_L_LeftRight_Deadband_Low)) {
									deadbandSpeed = ((deadbandSpeed - frc3535_Variables.js2_L_LeftRight_Deadband_Low)
											* frc3535_Variables.js2_L_LeftRight_Deadband_High);
								} else if ((deadbandSpeed < -frc3535_Variables.js2_L_LeftRight_Deadband_Low)) {
									deadbandSpeed = ((deadbandSpeed + frc3535_Variables.js2_L_LeftRight_Deadband_Low)
											* frc3535_Variables.js2_L_LeftRight_Deadband_High);
								} else {
									deadbandSpeed = 0; // If between boundaries. Do nothing.
					...
					case 2: // Right Analog Stick
						switch (direction) {
							case 1: // Up or Down
								deadbandSpeed = js2.getRawAxis(frc3535_Variables.axisD_rUpDown); // Speed controls up &
																									// down
								if ((deadbandSpeed > frc3535_Variables.js2_R_UpDown_Deadband_Low)) {
									deadbandSpeed = ((deadbandSpeed - frc3535_Variables.js2_R_UpDown_Deadband_Low)
											* frc3535_Variables.js2_R_UpDown_Deadband_High);
								} else if ((deadbandSpeed < -frc3535_Variables.js2_R_UpDown_Deadband_Low)) {
									deadbandSpeed = ((deadbandSpeed + frc3535_Variables.js2_R_UpDown_Deadband_Low)
											* frc3535_Variables.js2_R_UpDown_Deadband_High);
								} else {
									deadbandSpeed = 0; // If between boundaries. Do nothing.
							...
							case 2: // Left or Right
								deadbandSpeed = js2.getRawAxis(frc3535_Variables.axisD_rLeftRight); // Speed controls up
																									// & down
								if ((deadbandSpeed > frc3535_Variables.js2_R_LeftRight_Deadband_Low)) {
									deadbandSpeed = ((deadbandSpeed - frc3535_Variables.js2_R_LeftRight_Deadband_Low)
											* frc3535_Variables.js2_R_LeftRight_Deadband_High);
								} else if ((deadbandSpeed < -frc3535_Variables.js2_R_LeftRight_Deadband_Low)) {
									deadbandSpeed = ((deadbandSpeed + frc3535_Variables.js2_R_LeftRight_Deadband_Low)
											* frc3535_Variables.js2_R_LeftRight_Deadband_High);
								} else {
									deadbandSpeed = 0; // If between boundaries. Do nothing.
