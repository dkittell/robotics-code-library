...
public class Constants {
  ...
  public static final class LimelightConstants {
    ...
    public static final double CAMERA_HEIGHT = 2.8;
    public static final double TARGET_HEIGHT = 8.5;
  ...
  // region PID Loop
  public static final double pidKp = 0.195;
  public static final double pidKi = 0.010;
  public static final double pidKd = 0.0;
  public static final double pidKf = 0.184;
  public static final double pidKb = 0.0;
  public static final int pidMaxJerk = 31250;
  public static final int pidMaxAcceleration = 20000;
  // public static final int pidMaxSpeed = 1600;
  public static final int pidMaxSpeed = 1800; // 2021-03-08 New wheels
  // public static final int pidMaxVelocity = 5500;
  public static final int pidMaxVelocity = 6500; // 2021-03-08 New wheels
  // endregion PID Loop

  // region Intake Speed
  public static final double intake_in = -0.85;
  public static final double intake_out = 0.7;
  // endregion Intake Speed

  // region Uptake Speed
  public static final double uptake_up = -0.85;
  public static final double uptake_down = 0.7;
  // endregion Uptake Speed

  // region Climb Speed
  public static final double climb_up = -0.5;
  public static final double climb_down = 0.4;
  // endregion Climb Speed
