...
public class constants {
  ...
  public static final int can_id_elbow = 6;
  public static final int can_id_pdh = 7;
  public static final int can_id_extend = 8;
  ...
  // region Pneumatics
  public static final int p_dsL_Drivetrain_Forward_id = 0;
  public static final int p_dsL_Drivetrain_Reverse_id = 1;
  public static final int p_dsR_Drivetrain_Forward_id = 2;
  public static final int p_dsR_Drivetrain_Reverse_id = 3;
