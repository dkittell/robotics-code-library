...
@Autonomous(name = "testauton4 (Blocks to Java)", preselectTeleOp = "POWERPLAY-Starter-Bot-Teleop")
public class testauton4 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    right_drive.setTargetPosition((int) (1000 * driveCountsPermm));
    left_drive.setTargetPosition((int) (1000 * driveCountsPermm));
