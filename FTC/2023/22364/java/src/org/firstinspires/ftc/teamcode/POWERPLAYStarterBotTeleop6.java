...
@TeleOp(name = "POWERPLAYStarterBotTeleop6 (Blocks to Java)")
public class POWERPLAYStarterBotTeleop6 extends LinearOpMode {
      ...
      while (opModeIsActive()) {
        ...
        if (gamepad1.dpad_down) {
          ...
          if (gamepad1.dpad_up) {
            ...
            leftarmmotor.setPower(-0.15);
            rightarmmotor.setPower(-0.15);
          }
        }
