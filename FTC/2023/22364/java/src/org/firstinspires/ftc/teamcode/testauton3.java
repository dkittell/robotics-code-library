...
@Autonomous(name = "testauton3 (Blocks to Java)", preselectTeleOp = "POWERPLAY-Starter-Bot-Teleop")
public class testauton3 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    right_drive.setTargetPosition((int) (36 * driveCountsPermm));
    left_drive.setTargetPosition((int) (36 * driveCountsPermm));
