...
@Autonomous(name = "PoppysPlaytime17 (Blocks to Java)")
public class PoppysPlaytime17 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      leftTarget = left_drive.getCurrentPosition() + 30 * DRIVE_COUNTS_PER_IN;
