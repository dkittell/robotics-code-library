...
@TeleOp(name = "_2021starterbotblocks22 (Blocks to Java)")
public class _2021starterbotblocks22 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      while (opModeIsActive()) {
        ...
        LeftDrive.setPower(-(motorSpeed * (gamepad1.left_stick_y + gamepad1.left_stick_x * 0.75)));
        RightDrive.setPower(-(motorSpeed * (gamepad1.left_stick_y - gamepad1.left_stick_x * 0.75)));
      }
      telemetry.update();
      // INTAKE CODE
