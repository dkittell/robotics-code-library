...
@Autonomous(name = "PoppysPlaytimeRedSide8 (Blocks to Java)")
public class PoppysPlaytimeRedSide8 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      RightTurnieTurn = right_drive.getCurrentPosition() - 53 * DRIVE_COUNTS_PER_IN;
      LeftTurnieTurn = left_drive.getCurrentPosition() + 53 * DRIVE_COUNTS_PER_IN;
