...
@TeleOp(name = "_2021starterbotblocks20 (Blocks to Java)")
public class _2021starterbotblocks20 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      while (opModeIsActive()) {
        ...
        LeftDrive.setPower(-(motorSpeed * (gamepad1.left_stick_y + gamepad1.right_stick_x)));
        RightDrive.setPower(-(motorSpeed * (gamepad1.left_stick_y - gamepad1.right_stick_x)));
      }
      telemetry.update();
      // INTAKE CODE
