...
@Autonomous(name = "PoppysPlaytime41 (Blocks to Java)")
public class PoppysPlaytime41 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      // Put run blocks here.
      rightTarget = right_drive.getCurrentPosition() + 23 * DRIVE_COUNTS_PER_IN;
      leftTarget = left_drive.getCurrentPosition() + 23 * DRIVE_COUNTS_PER_IN;
      RightTurnieTurn = right_drive.getCurrentPosition() + 58 * DRIVE_COUNTS_PER_IN;
      LeftTurnieTurn = left_drive.getCurrentPosition() - 58 * DRIVE_COUNTS_PER_IN;
      RightBacksmackahat = right_drive.getCurrentPosition() - 60 * DRIVE_COUNTS_PER_IN;
      LeftBacksmackahat = left_drive.getCurrentPosition() - 60 * DRIVE_COUNTS_PER_IN;
