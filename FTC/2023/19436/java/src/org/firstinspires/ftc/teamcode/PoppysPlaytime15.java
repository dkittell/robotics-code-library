...
@Autonomous(name = "PoppysPlaytime15 (Blocks to Java)")
public class PoppysPlaytime15 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      // Put run blocks here.
      rightTarget = right_drive.getCurrentPosition() + 90 * DRIVE_COUNTS_PER_IN;
      leftTarget = left_drive.getCurrentPosition() + 90 * DRIVE_COUNTS_PER_IN;
      RightTurnieTurn = right_drive.getCurrentPosition() + 10 * DRIVE_COUNTS_PER_IN;
      LeftTurnieTurn = left_drive.getCurrentPosition() - 10 * DRIVE_COUNTS_PER_IN;
      ...
      right_drive.setTargetPosition((int) RightTurnieTurn);
      left_drive.setTargetPosition((int) LeftTurnieTurn);
