...
@Autonomous(name = "PoppysPlaytime34 (Blocks to Java)")
public class PoppysPlaytime34 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      RightTurnieTurn = right_drive.getCurrentPosition() + 65 * DRIVE_COUNTS_PER_IN;
      LeftTurnieTurn = left_drive.getCurrentPosition() - 65 * DRIVE_COUNTS_PER_IN;
