...
@Autonomous(name = "PoppysPlaytime33 (Blocks to Java)")
public class PoppysPlaytime33 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      RightBacksmackahat = right_drive.getCurrentPosition() - 100 * DRIVE_COUNTS_PER_IN;
      LeftBacksmackahat = left_drive.getCurrentPosition() - 100 * DRIVE_COUNTS_PER_IN;
