...
@TeleOp(name = "_2021starterbotblocks21 (Blocks to Java)")
public class _2021starterbotblocks21 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      while (opModeIsActive()) {
        ...
        LeftDrive.setPower(-(motorSpeed * (gamepad1.left_stick_y + gamepad1.left_stick_x * 0.5)));
        RightDrive.setPower(-(motorSpeed * (gamepad1.left_stick_y - gamepad1.left_stick_x * 0.5)));
      }
      telemetry.update();
      // INTAKE CODE
