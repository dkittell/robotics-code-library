...
@Autonomous(name = "PoppysPlaytime14 (Blocks to Java)")
public class PoppysPlaytime14 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      // Put run blocks here.
      rightTarget = right_drive.getCurrentPosition() + 15 * DRIVE_COUNTS_PER_IN;
