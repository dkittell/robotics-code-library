...
@Autonomous(name = "PoppysPlaytime35 (Blocks to Java)")
public class PoppysPlaytime35 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      RightTurnieTurn = right_drive.getCurrentPosition() + 60 * DRIVE_COUNTS_PER_IN;
      LeftTurnieTurn = left_drive.getCurrentPosition() - 60 * DRIVE_COUNTS_PER_IN;
      RightBacksmackahat = right_drive.getCurrentPosition() - 115;
