...
@Autonomous(name = "PoppysPlaytime20 (Blocks to Java)")
public class PoppysPlaytime20 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      right_drive.setTargetPosition((int) RightBacksmackahat);
      left_drive.setTargetPosition((int) LeftBacksmackahat);
      while (opModeIsActive() && (right_drive.isBusy() || left_drive.isBusy())) {
      }
