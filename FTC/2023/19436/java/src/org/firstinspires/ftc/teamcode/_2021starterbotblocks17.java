...
@TeleOp(name = "_2021starterbotblocks17 (Blocks to Java)")
public class _2021starterbotblocks17 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      while (opModeIsActive()) {
        ...
        LeftDrive.setPower(-(0.7 + gamepad1.left_stick_y + gamepad1.left_stick_x));
        RightDrive.setPower(-(0.7 + (gamepad1.left_stick_y - gamepad1.left_stick_x)));
      }
      telemetry.update();
      // INTAKE CODE
