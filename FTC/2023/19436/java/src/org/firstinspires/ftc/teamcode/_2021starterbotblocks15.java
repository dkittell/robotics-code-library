...
@TeleOp(name = "_2021starterbotblocks15 (Blocks to Java)")
public class _2021starterbotblocks15 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      while (opModeIsActive()) {
        ...
        LeftDrive.setPower(-(gamepad1.left_stick_y + gamepad1.right_stick_y));
        RightDrive.setPower(-(gamepad1.left_stick_y - gamepad1.right_stick_y));
      }
      telemetry.update();
      // INTAKE CODE
