...
@Autonomous(name = "PoppysPlaytime38 (Blocks to Java)")
public class PoppysPlaytime38 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      RightTurnieTurn = right_drive.getCurrentPosition() + 57 * DRIVE_COUNTS_PER_IN;
      LeftTurnieTurn = left_drive.getCurrentPosition() - 57 * DRIVE_COUNTS_PER_IN;
