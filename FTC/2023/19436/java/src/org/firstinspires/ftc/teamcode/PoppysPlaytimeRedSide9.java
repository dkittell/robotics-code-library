...
@Autonomous(name = "PoppysPlaytimeRedSide9 (Blocks to Java)")
public class PoppysPlaytimeRedSide9 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      RightTurnieTurn = right_drive.getCurrentPosition() - 52 * DRIVE_COUNTS_PER_IN;
      LeftTurnieTurn = left_drive.getCurrentPosition() + 52 * DRIVE_COUNTS_PER_IN;
