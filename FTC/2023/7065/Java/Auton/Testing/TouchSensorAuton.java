...
@Autonomous(
  name = "Touch Sensor Concept 2",
  group = "Red",
  preselectTeleOp = "Scooter Drivetrain 2023"
)
public class TouchSensorConcept2 extends LinearOpMode {
    ...
    if (opModeIsActive()) {
      ...
      if (tsChassis.isPressed() == false) {
        ...
        if (tsChassis.isPressed() == false) {
          ...
          // Drive to position 3
          DriveRobotEncoder(1, 0.3, 5, 9.5); // Strafe right
          driveStraight(0.3, 7, 0); // Drive forward 12 inches
