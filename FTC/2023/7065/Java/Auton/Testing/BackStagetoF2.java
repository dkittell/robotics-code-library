...
@Autonomous(
  name = "Backstage To F2",
  group = "Competition",
  preselectTeleOp = "Scooter Drivetrain 2023"
)
public class BackStagetoF2 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    waitForStart();
    if (opModeIsActive()) {
      // region Change For Auton Purposes
      turnToHeading(0.3, 180);
      resetHeading();
      driveStraight(DRIVE_SPEED, 77, 0); // Drive backwards from backstage to F2
      resetHeading();
      DriveRobotEncoder(1, 0.5, 5, 2.5); // Strafe right 2.5 inch from wall
      resetHeading();
      ...
      // endregion Change For Auton Purposes
    }
  }
