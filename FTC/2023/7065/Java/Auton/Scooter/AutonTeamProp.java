...
public class AutonTeamProp extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      if (tsChassis.isPressed() == false) {
        ...
        driveStraight(0.5, 12, 0); // drive straight
        resetHeading();
        turnToHeading(0.5, -88); // Turn 90 degrees to the right
        resetHeading();
        driveStraight(0.5, 15, 0); // drive straight
        resetHeading();
        ...
        if (tsChassis.isPressed() == false) {
          ...
          // Drive to position 3
          DriveRobotEncoder(1, 0.5, 5, 10.5); // Strafe right
          driveStraight(0.5, 4, 0); // Drive forward 12 inches
          ...
          DriveRobotEncoder(1, 0.5, 5, 4);
          driveStraight(0.8, 69, 0);
          DriveRobotEncoder(1, 0.5, 4, 6);
          resetHeading();
          sleep(100);
        mPivot.setPower(0.8);
        mPivot.setTargetPosition(-3800);
        sleep(2100);
        driveStraight(0.3, 6, 0);
        mPivot.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        mLinear1.setPower(0.8);
        mLinear1.setTargetPosition(1900);
        mLinear1.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        mLinear2.setPower(0.8);
        mLinear2.setTargetPosition(1900);
        mLinear2.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        sleep(2000);
