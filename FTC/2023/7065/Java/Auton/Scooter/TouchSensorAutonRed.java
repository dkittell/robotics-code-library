...
@Autonomous(
  name = "Touch Sensor Auton Red",
  group = "Red",
  preselectTeleOp = "Field Oriented Linear 2023"
)
public class TouchSensorAutonRed extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      mPivot.setPower(0.2);
      mPivot.setTargetPosition(-210);
      mPivot.setMode(DcMotor.RunMode.RUN_TO_POSITION);
      sleep(100);

      // Get to position 1
      DriveRobotEncoder(1, 0.3, 4, 15.5); // Strafe left 15.5 inches
      driveStraight(0.3, 24, 0); // Drive forward 20 inches
      ...
      if (tsChassis.isPressed() == false) {
        ...
        DriveRobotEncoder(1, 0.3, 4, 3); // Strafe left
        driveStraight(0.3, 12, 0); // drive straight
        resetHeading();
        turnToHeading(0.3, -90); // Turn 90 degrees to the right
        resetHeading();
        driveStraight(0.3, 15, 0); // drive straight
        resetHeading();
        ...
        if (tsChassis.isPressed() == false) {
          ...
          // Drive to position 3
          DriveRobotEncoder(1, 0.3, 5, 10.5); // Strafe right
          driveStraight(0.3, 4, 0); // Drive forward 12 inches
