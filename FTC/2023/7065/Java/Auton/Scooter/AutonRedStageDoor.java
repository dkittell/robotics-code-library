...
@Autonomous(
  name = "Stage Door Auton Red",
  group = "Red",
  preselectTeleOp = "Field Oriented Linear 2023"
)
public class AutonRedStageDoor extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      // Get to position 1
      DriveRobotEncoder(1, 0.5, 4, 14); // Strafe left 15.5 inches
      driveStraight(0.35, 25, 0); // Drive forward 20 inches
      ...
      if (tsChassis.isPressed() == false) {
        ...
        resetHeading();
        driveStraight(0.8, -6, 0);
        resetHeading();
        DriveRobotEncoder(1, 0.8, 5, 11.5);
        ...
        DriveRobotEncoder(1, 0.5, 4, 3); // Strafe left
        driveStraight(0.5, 10.5, 0); // drive straight
        resetHeading();
        turnToHeading(0.5, -88); // Turn 90 degrees to the right
        resetHeading();
        driveStraight(0.35, 15, 0); // drive straight
        resetHeading();
        ...
        if (tsChassis.isPressed() == false) {
          ...
          sBackRightIntake.setPower(0);
          driveStraight(0.3, -6, 0); // Drive Backward 6 inches
          DriveRobotEncoder(1, 0.5, 4, 15);
          resetHeading();
          driveStraight(0.8, 70, 0);
          sleep(1000);
          turnToHeading(0.5, 0);
          DriveRobotEncoder(1, 0.8, 5, 27);
          resetHeading();
          sleep(100);
          mPivot.setPower(0.8);
          mPivot.setTargetPosition(-2200);
          ...
          sleep(100);
          // Drive to position 3
          DriveRobotEncoder(1, 0.5, 5, 13); // Strafe right

          driveStraight(0.5, 6.5, 0); // Drive forward 12 inches
