...
@TeleOp(name = "Single Operator", group = "Linear Opmode")
public class SingleOperator extends LinearOpMode {
  ...
  public void runOpMode() throws InterruptedException {
    ...
    while (opModeIsActive()) {
      ...
      if (gamepad1.left_bumper) {
        ...
        if (gamepad1.left_trigger > 0.17) {
          sFrontLeftIntake.setPower(1);
          sBackLeftIntake.setPower(1);
          sFrontRightIntake.setPower(1);
          sBackRightIntake.setPower(1);
        } else if (gamepad1.right_trigger > 0.17) {
          sFrontLeftIntake.setPower(-1);
          sBackLeftIntake.setPower(-1);
          sFrontRightIntake.setPower(-1);
          sBackRightIntake.setPower(-1);
