...
public class Auton_B2R1 extends LinearOpMode {
...
boolean BoltDetected;
     boolean PanelDetected;
     boolean BulbDetected;
  ...
  public void runOpMode() {
   ...
   BoltDetected = false;
    ...
    if (opModeIsActive()) {
      ...
      DriveRobotEncoder(1, 0.5, 5, 1); // Strafe away from junction
      resetHeading();
      ...
      // resetHeading(); //dec 5 2022
      sleep(1000);
      driveStraight(0.7, -11.5, 0);
      // resetHeading(); //dec 5 2022
      turnToHeading(TURN_SPEED, 39);
      resetHeading();
      ArmEncoder(1, 3000, 1);
      resetHeading();
      telemetry.update();

      driveStraight(0.6, 8, 0);
      resetHeading();
      sleep(1000);
      sGrabOne.setPower(-1);
      sGrabTwo.setPower(1);
      ...
      turnToHeading(TURN_SPEED, -122);
      resetHeading();
      DriveRobotEncoder(1, 0.5, 5, 0.75);
      resetHeading();
