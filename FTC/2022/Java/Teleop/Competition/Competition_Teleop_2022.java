...
// @Disabled
@TeleOp(name = "2022 Iterative", group = "Iterative Opmode")
public class Competition_Teleop_2022 extends OpMode {
  ...
  public void loop() {
    ...
    //   //  mArm.setPower((-gamepad2.left_stick_y * dOperatorGear));
    //   mArm.setPower((-gamepad2.left_stick_y * dOperatorGear));
    // }
