...
@Disabled
@Autonomous(name = "Vision_Joe2")
public class Vision_Joe2 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    tfod.useModelFromFile("FinalVision.tflite", JavaUtil.createListWith(Horse, Lego, Tobar), true, true, 300);
    tfod.initialize(vuforiaPOWERPLAY, (float) 0.3, true, true);
