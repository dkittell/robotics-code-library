...
public class Blue1 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    Color_Sensor_REV_ColorRangeSensor =
    ...
    if (opModeIsActive()) {
      ...
      // Green = (JavaUtil.colorToSaturation(CurrentColor) >= 0.6 && JavaUtil.colorToHue(CurrentColor) > 81 && JavaUtil.colorToHue(CurrentColor)) < 140;
      // Blue = (JavaUtil.colorToSaturation(CurrentColor) >= 0.6 && JavaUtil.colorToHue(CurrentColor) > 210 && JavaUtil.colorToHue(CurrentColor)) < 275;
      // Purple = (JavaUtil.colorToSaturation((int) CurrentColor) <= 0.4 && (JavaUtil.colorToHue((int) CurrentColor) >= 317 || JavaUtil.colorToHue((int) CurrentColor) <= 270));
      ...
      //   sleep(1000);
      //   telemetry.update();
      // put preloaded cone onto high junction
