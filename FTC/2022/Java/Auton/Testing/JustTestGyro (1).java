...
public class JustTestGyro extends LinearOpMode {
  ...
  static final double P_DRIVE_GAIN = 0.35; // Larger is more responsive, but also less stable
  static final double P_TURN_GAIN = 0.12; // Larger is more responsive, but also less stable
