...
public class Auton_Vision_Gyro extends LinearOpMode {
  ...
  boolean isHorseDetected;
  String Horse;
  boolean isLegoDetected;
  String Lego;
  boolean isTobarDetected;
  String Tobar;
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      DriveRobotEncoder(1, 0.6, 5, 20);
      resetHeading();
      telemetry.update();
      driveStraight(DRIVE_SPEED, 41.0, 0.0);
      telemetry.update();
      DriveRobotEncoder(1, 0.4, 4, 11.5);
      resetHeading();
      telemetry.update();
      ...
      mArm.setPower(0);
      //end of preloaded cone, now moving to stacks
      DriveRobotEncoder(250, 0.4, 4, 12);
      resetHeading();
      ...
      // sleep(500);
      // resetHeading();
      // ArmEncoder(0.6, 400, 200); // move arm down to grab cone
      // resetHeading();
      // ArmEncoder(0.6, 1500, 200);
      // resetHeading();
      // driveStraight(DRIVE_SPEED, -5, 0.0); // Drive backwards away from stack
      // resetHeading();
      // sGrabOne.setPower(-1);
      // sGrabTwo.setPower(1);
      // sleep(500);
