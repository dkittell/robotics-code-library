...
@Autonomous(name = "Mark Encoder Square B (Java)", group = "")
public class Mark_Encoder_SquareB extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    double dStrafeLeft02 = 57.0; // inches
    int tStrafeLeft02 = (int) Math.round(tPerInch * dStrafeLeft02);
    double dBackwardToPark = 96.0; // inches
