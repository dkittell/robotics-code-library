...
@Autonomous(name = "MarkSquare (Java)", group = "")
@Disabled
public class MarkSquare extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    FrontLeft.setTargetPosition(tF);
    BackLeft.setTargetPosition(tF);
    FrontRight.setTargetPosition(tF);
    BackRight.setTargetPosition(tF);
    ...
    FrontLeft.setTargetPosition(-tLS);
    BackLeft.setTargetPosition(tLS);
    FrontRight.setTargetPosition(tLS);
    BackRight.setTargetPosition(-tLS);
    ...
    FrontLeft.setTargetPosition(-tB);
    BackLeft.setTargetPosition(-tB);
    FrontRight.setTargetPosition(-tB);
    BackRight.setTargetPosition(-tB);
    FrontLeft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
    BackLeft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
    FrontRight.setMode(DcMotor.RunMode.RUN_TO_POSITION);
    BackRight.setMode(DcMotor.RunMode.RUN_TO_POSITION);
    ...
    FrontRight.setDirection(DcMotorSimple.Direction.REVERSE);
    BackRight.setDirection(DcMotorSimple.Direction.REVERSE);
    // endregion reset encoder and reverse direction

    // region strafe right
    androidTextToSpeech.speak("I will strafe right");
    FrontLeft.setTargetPosition(tRS);
    BackLeft.setTargetPosition(-tRS);
    FrontRight.setTargetPosition(-tRS);
    BackRight.setTargetPosition(tRS);
    FrontLeft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
    BackLeft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
    FrontRight.setMode(DcMotor.RunMode.RUN_TO_POSITION);
    BackRight.setMode(DcMotor.RunMode.RUN_TO_POSITION);
