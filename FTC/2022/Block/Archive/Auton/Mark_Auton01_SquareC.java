...
@Autonomous(name = "Mark Auton 01 Square C (Java)", group = "")
public class Mark_Auton01_SquareC extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    double dInchesStrafeRightToSquareC = 135;
    int tRightStrafeToSquareC = (int) Math.round(tPerInch * dInchesStrafeRightToSquareC);
    ...
    double dInchesStrafeLeftToPark = 65.0; // inches
    int tStrafeLeftToPark = (int) Math.round(tPerInch * dInchesStrafeLeftToPark);
    ...
    FrontLeft.setTargetPosition(tRightStrafeToSquareC);
    BackLeft.setTargetPosition(-tRightStrafeToSquareC);
    FrontRight.setTargetPosition(-tRightStrafeToSquareC);
    BackRight.setTargetPosition(tRightStrafeToSquareC);
