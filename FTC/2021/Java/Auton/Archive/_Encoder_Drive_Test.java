...
public class _Encoder_Drive_Test extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            FrontLeft.setTargetPosition((int) ecForward);
            BackLeft.setTargetPosition((int) ecForward);
            FrontRight.setTargetPosition((int) ecForward);
            BackRight.setTargetPosition((int) ecForward);
