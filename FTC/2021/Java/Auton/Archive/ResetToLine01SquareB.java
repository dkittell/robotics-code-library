...
@Autonomous(name = "Reset To Line 01 Square B(Java)", group = "")
public class ResetToLine01SquareB extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    telemetry.addData("Encoder Counts To Move", tLeftStrafeToLine01);
    telemetry.update();
    waitForStart();
