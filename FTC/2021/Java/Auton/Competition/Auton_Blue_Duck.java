...
@Autonomous(name = "Blue Duck", group = "Competition", preselectTeleOp = "Competition 2021 Teleop")
public class Auton_Blue_Duck extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
          ...
          telemetry.speak("Forward", null, null);
            DriveRobotEncoder(1000, 0.5, 0, 3);
            ...
            telemetry.speak("Strafe right", null, null);
            DriveRobotEncoder(1000, 0.5, 5, 23);
            ...
            sleep(2700);
             ...
             telemetry.speak("Forward", null, null);
            DriveRobotEncoder(1000, 0.5, 0, 23);
