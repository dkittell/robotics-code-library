...
@Autonomous(name = "Blue Warehouse", group = "Competition", preselectTeleOp = "Competition 2021 Teleop")
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
          ...
          //  DriveRobotEncoder(1000, 0.5, 0, 41);
            ...
            telemetry.speak("Strafe right", null, null);
            DriveRobotEncoder(1000, 0.5, 5, 20);

            telemetry.speak("Forward", null, null);
            DriveRobotEncoder(1000, 1, 0,60);
